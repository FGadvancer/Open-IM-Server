...
# 设置 Docker 网络的网段
readonly DOCKER_BRIDGE_SUBNET=${DOCKER_BRIDGE_SUBNET:-'172.30.0.0/16'}
...
# OpenIM Websocket端口
readonly OPENIM_WS_PORT=${OPENIM_WS_PORT:-'20001'}

# OpenIM API端口
readonly API_OPENIM_PORT=${API_OPENIM_PORT:-'20002'}
...
def "OPENIM_CHAT_API_PORT" "20008"                   # OpenIM API端口
def "CHAT_API_LISTEN_IP" ""                          # OpenIM API的监听IP

def "OPENIM_ADMIN_API_PORT" "20009" # OpenIM Admin API端口
...
def "ZOOKEEPER_PORT" "22181"                       # Zookeeper的端口
...
def "KAFKA_PORT" "29094"                                    # `Kafka` 的端口
...
###################### openim-web 配置信息 ######################
def "OPENIM_WEB_PORT" "21001"                       # openim-web的端口
...
def "OPENIM_ADMIN_FRONT_PORT" "21002"                       # openim-admin-front的端口
...
# OpenIM用户服务端口
readonly OPENIM_USER_PORT=${OPENIM_USER_PORT:-'30110'}
# OpenIM朋友服务端口
readonly OPENIM_FRIEND_PORT=${OPENIM_FRIEND_PORT:-'30120'}
# OpenIM消息服务端口
readonly OPENIM_MESSAGE_PORT=${OPENIM_MESSAGE_PORT:-'30130'}
# OpenIM消息网关服务端口
readonly OPENIM_MESSAGE_GATEWAY_PORT=${OPENIM_MESSAGE_GATEWAY_PORT:-'30140'}
# OpenIM组服务端口
readonly OPENIM_GROUP_PORT=${OPENIM_GROUP_PORT:-'30150'}
# OpenIM授权服务端口
readonly OPENIM_AUTH_PORT=${OPENIM_AUTH_PORT:-'30160'}
# OpenIM推送服务端口
readonly OPENIM_PUSH_PORT=${OPENIM_PUSH_PORT:-'30170'}
# OpenIM对话服务端口
readonly OPENIM_CONVERSATION_PORT=${OPENIM_CONVERSATION_PORT:-'30180'}
# OpenIM第三方服务端口
readonly OPENIM_THIRD_PORT=${OPENIM_THIRD_PORT:-'30190'}
...
readonly RTC_PROM_PORT=${RTC_PROM_PORT:-'31300'}
# Third 服务的 Prometheus 端口
readonly THIRD_PROM_PORT=${THIRD_PROM_PORT:-'31301'}

# Message Transfer 服务的 Prometheus 端口列表
readonly MSG_TRANSFER_PROM_PORT=${MSG_TRANSFER_PROM_PORT:-'31400, 31401, 31402, 31403'}
readonly MSG_TRANSFER_PROM_ADDRESS_PORT=${MSG_TRANSFER_PROM_ADDRESS_PORT:-"${DOCKER_BRIDGE_GATEWAY}:31400, ${DOCKER_BRIDGE_GATEWAY}:31401, ${DOCKER_BRIDGE_GATEWAY}:31402, ${DOCKER_BRIDGE_GATEWAY}:31403"}
